                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td valign="top" class="textContent">
                                                                        <h3>Aplicación de: {{ $usuario->name}}</h3>
                                                                                                ...
                                                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                    <tr>
                                                                                                        <td align="center" valign="top" class="emailCalendarMonth">
                                                                                                            {{ strftime('%B', strtotime($actividad->inicio)) }}
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td align="center" valign="top" class="emailCalendarDay">
                                                                                                            {{ strftime('%e', strtotime($actividad->inicio)) }} 
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
                                                                        ...
                                                                        <table align="Left" border="0" cellpadding="0" cellspacing="0" width="320" class="flexibleContainer">
                                                                            <tr>
                                                                                <td valign="top" class="textContent">
                                                                                    <h3>Finaliza</h3>
                                                                                    <br />
                                                                                    {{ strftime('%A, %e de %B del %Y', strtotime($actividad->final)) }}
                                                                                    <br />
                                                                                    {{ strftime('%I:%M:%S %p', strtotime($actividad->final)) . ((strtotime($actividad->final) % 86400) < 43200 ? 'AM' : 'PM') }} 
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        <!-- // CONTENT TABLE -->
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center" valign="top" style="padding:5px;">
                                                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                    <tr>
                                                                                                        <td align="center" valign="top" class="emailCalendarMonth">
                                                                                                            {{ strftime('%B', strtotime($actividad->final)) }}
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td align="center" valign="top" class="emailCalendarDay">
                                                                                                            {{ strftime('%e', strtotime($actividad->final)) }} 
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
                                                                                    ...
                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="260" class="emailButton">
                                                                                        <tr>
                                                                                            <td align="center" valign="middle" class="buttonContent">
                                                                                                <a href="{{ route('actividad', [str_slug($actividad->nombre), encrypt($actividad->id) ]) }}" target="_blank">Ver actividad</a>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                    <!-- // CONTENT TABLE -->
